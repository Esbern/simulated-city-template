...
- ❌ AI writes code → **Reject:** "No code yet. Only clarify the design."
- ❌ AI proposes 5 phases at once → **Reject:** "Just describe the phases. I'll approve before any implementation."
